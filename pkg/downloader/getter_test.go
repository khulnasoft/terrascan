...
func TestGetURLSubDir(t *testing.T) {
	...
	table := []struct {
	...
	}{
		{
			...
			URL:        "github.com/khulnasoft/terrascan",
			dest:       someDest,
			wantURL:    "git::https://github.com/khulnasoft/terrascan.git",
			wantSubDir: "",
			wantErr:    nil,
		},
		{
			name:       "github url with subdir",
			URL:        "github.com/khulnasoft/terrascan//some-subdir",
			dest:       someDest,
			wantURL:    "git::https://github.com/khulnasoft/terrascan.git",
		...
		{
			name:       "github ssh url",
			URL:        "git@github.com:khulnasoft/terrascan.git//some-subdir",
			dest:       someDest,
			wantURL:    "git::ssh://git@github.com/khulnasoft/terrascan.git",
			wantSubDir: someSubdir,
			wantErr:    nil,
		},
		{
